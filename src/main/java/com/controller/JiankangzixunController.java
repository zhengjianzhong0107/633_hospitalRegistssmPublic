...
public class JiankangzixunController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JiankangzixunEntity jiankangzixun, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JiankangzixunEntity jiankangzixun, HttpServletRequest request){
        EntityWrapper<JiankangzixunEntity> ew = new EntityWrapper<JiankangzixunEntity>();
    	PageUtils page = jiankangzixunService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jiankangzixun), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
