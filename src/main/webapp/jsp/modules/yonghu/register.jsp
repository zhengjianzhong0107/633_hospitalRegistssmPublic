                        ...
                        <div class="form d-flex align-items-center">
                            <div class="content">
                                <form id="registerForm" action="" method="post" class="form-validate">
									<input type="text" placeholder="请输入用户名" name="yonghuming" class="input-material">
									<input type="password" placeholder="请输入密码" name="mima" class="input-material">
									<input type="text" placeholder="请输入姓名" name="xingming" class="input-material">
									<input type="text" placeholder="请输入手机" name="shouji" class="input-material">
