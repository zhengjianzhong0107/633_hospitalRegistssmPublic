					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">收藏表管理</li>
								<li class="breadcrumb-item active">收藏表列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">收藏表列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																																																																																		<label>
												收藏名称
												<input type="text" id="nameSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('userid')">用户id<i id="useridIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('refid')">收藏id<i id="refidIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('tablename')">表名<i id="tablenameIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('name')">收藏名称<i id="nameIcon" class="fa fa-sort"></i></th>
	...
	<script>
							...
							var useridCell  = document.createElement('td');
									...
									row.appendChild(refidCell);
				            				var tablenameCell  = document.createElement('td');
												 ...
												 tablenameCell.innerHTML = item.tablename;
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("storeup/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"storeup");
