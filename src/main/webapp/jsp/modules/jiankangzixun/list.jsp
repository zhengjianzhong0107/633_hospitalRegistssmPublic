...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">健康资讯管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">健康资讯列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">健康资讯列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
												...
												<input type="text" id="zixunbiaotiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
																																																														...
																																																														<label>
												资讯类型
												<input type="text" id="zixunleixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('zixunbiaoti')">资讯标题<i id="zixunbiaotiIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('zixunleixing')">资讯类型<i id="zixunleixingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
					...
					searchForm.zixunbiaoti ="%" +  $('#zixunbiaotiSearch').val() + "%";
																				...
																				if($('#zixunleixingSearch').val() != null && $('#zixunleixingSearch').val() != ''){
					searchForm.zixunleixing ="%" +  $('#zixunleixingSearch').val() + "%";
				}
        ...
        function getDataList() {
			http("jiankangzixun/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
																						zixunbiaoti : searchForm.zixunbiaoti,	
																																	zixunleixing : searchForm.zixunleixing,	
																																																						},(res)=>{
				if(res.code == 0){
					clear();
			...
			row.appendChild(checkbox)
							...
							var zixunbiaotiCell  = document.createElement('td');
									...
									row.appendChild(zixunbiaotiCell);
				            				var zixunleixingCell  = document.createElement('td');

												 zixunleixingCell.innerHTML = item.zixunleixing;

				
									row.appendChild(zixunleixingCell);
				  	 ...
				  	 if(item.neirong != null && item.neirong != "" && item.neirong.length >= 11){
				  		...
				  		neirongCell.innerHTML = item.neirong;
									...
									row.appendChild(neirongCell);
				            				var ziliaofujianCell  = document.createElement('td');

												  var ziliaofujianFile = document.createElement('button');
				  ziliaofujianFile.innerHTML = '下载';
				  var ziliaofujianFileAttr = "download('" + item.ziliaofujian + "')"
				  ziliaofujianFile.setAttribute('onclick',ziliaofujianFileAttr);
                  ziliaofujianCell.appendChild(ziliaofujianFile);

                
									row.appendChild(ziliaofujianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiankangzixun/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jiankangzixun");
