...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">医生坐诊评论表管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">医生坐诊评论表管理</li>
								<li class="breadcrumb-item active">医生坐诊评论表列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">医生坐诊评论表列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																																																															<label>
												评论内容
												<input type="text" id="contentSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
											...
											<th class="no-sort" style="min-width: 35px;">
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('refid')">关联表id<i id="refidIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		var tableName = "discussyishengzuozhen";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
		...
		function search(){
			searchForm = { key: ""};
					...
					searchForm.content ="%" +  $('#contentSearch').val() + "%";
				}
        ...
        function getDataList() {
			http("discussyishengzuozhen/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
							...
							var refidCell  = document.createElement('td');

												 refidCell.innerHTML = item.refid;
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussyishengzuozhen/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("discussyishengzuozhen"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"discussyishengzuozhen");
