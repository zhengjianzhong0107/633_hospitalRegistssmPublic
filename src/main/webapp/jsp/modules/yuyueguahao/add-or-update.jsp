...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑预约挂号</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">编辑预约挂号</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">预约挂号信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="yuyuebianhao" name="yuyuebianhao" class="form-control" value="" readonly>
											...
											<div class="form-group col-md-6">
										<label>预约名称</label>
										<input id="yuyuemingcheng" name="yuyuemingcheng" class="form-control" placeholder="预约名称">
									</div>
											<div class="form-group col-md-6">
										<label>医生工号</label>
										...
										<input name="touxiang" id="touxiang-input" type="hidden">
											...
											<div class="form-group col-md-6">
										<label>预约时间</label>
										<div id="yuyueshijianDate" class="input-append date form_datetime">
											<input id="yuyueshijian-input" name="yuyueshijian" size="20" type="text" readonly>
										...
										<input id="shouji" name="shouji" class="form-control" placeholder="手机">
																							...
																							<label>预约内容</label>
																							<input id="yuyueneirongupload" name="file" type="file">
												<script id="yuyueneirongEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var yuyueneirongUe = UE.getEditor('yuyueneirongEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" name="yuyueneirong" id="yuyueneirong-input">
											</div>	
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function upload(){
						...
						dataType: 'json',
							...
							$("#touxiangImg").attr("src",baseUrl+"upload/"+data.result.file);								
																														...
																														$('#yuyueneirongupload').fileupload({
						url: baseUrl + 'file/upload',
						headers:{ token: window.sessionStorage.getItem("token")},
						dataType: 'json',
						done: function (e, data) {	
							UE.getEditor('yuyueneirongEditor').execCommand('insertHtml','<img src=\"'+ baseUrl +'upload/'+ data.result.file + '\" width=900 height=560>');					
						}
					});
																																																										}  
		...
		// 填充富文本框
		function setContent(){
																																																				if(ruleForm.yuyueneirong != null && ruleForm.yuyueneirong != 'null' && ruleForm.yuyueneirong != ''){
					var yuyueneirongMes = '' + ruleForm.yuyueneirong;
					var yuyueneirongUeditor = UE.getEditor('yuyueneirongEditor');
					yuyueneirongUeditor.ready(function() {
						yuyueneirongUeditor.setContent(yuyueneirongMes);
					});
				}
																																																		}  
		...
		// 获取富文本框内容
		function getContent(){
																																																				if(UE.getEditor('yuyueneirongEditor').hasContents()){
					$('#yuyueneirong-input').attr('value',UE.getEditor('yuyueneirongEditor').getPlainTxt());
				}
																																																		}
		...
		function dateTimePick(){
			$.fn.datetimepicker.dates['zh-CN'] = { 
		            ...
		            meridiem: ["上午", "下午"]
																																														...
																																														$("#yuyueshijianDate").datetimepicker({ 
					autoclose: true,
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#yuyuebianhao").val(ruleForm.yuyuebianhao);	
																$("#yuyuemingcheng").val(ruleForm.yuyuemingcheng);	
																...
																$("#yuyueneirong").val(ruleForm.yuyueneirong);	
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.yuyuemingcheng != null && res.data.yuyuemingcheng != ''){

															$("#yuyuemingcheng").val(res.data.yuyuemingcheng);
													}
								...
								$('#yuyueshijianFileName').val(res.data.yuyueshijian)
												...
												if(res.data != null && res.data != '' && res.data.yuyueneirong != null && res.data.yuyueneirong != ''){

															$("#yuyueneirong").val(res.data.yuyueneirong);
													}
