...
<body>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
																					<div class="form-group col-md-6">
																								...
																								<input id="yuyuebianhao" name="yuyuebianhao" class="form-control" v-model="ruleForm.yuyuebianhao" readonly>
																							</div>
											
																					<div class="form-group col-md-6">
																								<label>预约名称</label>
												
																								<input id="yuyuemingcheng" name="yuyuemingcheng" class="form-control" v-model="ruleForm.yuyuemingcheng" readonly>
																							</div>
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="yuyueshijian" name="yuyueshijian" class="form-control" v-model="ruleForm.yuyueshijian" readonly>
																							</div>
	...
	<script>
		...
		function setContent(){
					...
					var mes = '' + ruleForm.yuyueneirong;
					var yuyueneirongUeditor = UE.getEditor('yuyueneirongEditor');
					yuyueneirongUeditor.ready(function() {
						yuyueneirongUeditor.setContent(mes);
						yuyueneirongUeditor.setDisabled('fullscreen');
					});
				}
