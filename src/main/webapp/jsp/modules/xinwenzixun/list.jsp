							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									...
									<button onclick="add()" type="button"
										class="btn btn-success 新增">添加</button>
									<button onclick="deleteMore()" type="button"
										class="btn btn-danger 删除">批量删除</button>
								</div>
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('title')">标题<i id="titleIcon"
												class="fa fa-sort"></i></th>

											<th>图片</th>
											<th onclick="sort('content')">内容<i id="contentIcon"
												class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
	...
	<%@ include file="../../static/toLogin.jsp"%>
		...
		function setDataRow(item, number) {
			...
			if (item.content.indexOf('img') != -1) {
				...
				contentCell.innerHTML = item.content.substring(beginIndex,
						endIndex + 1);
			} else {
