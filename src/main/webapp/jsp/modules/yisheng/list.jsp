...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">医生列表</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												医生工号
												<input type="text" id="yishenggonghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
																																																																																	<label>
												医生姓名
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
													if($('#yishenggonghaoSearch').val() != null && $('#yishenggonghaoSearch').val() != ''){
					searchForm.yishenggonghao ="%" +  $('#yishenggonghaoSearch').val() + "%";
				}
        ...
        function getDataList() {
			http("yisheng/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
																						yishenggonghao : searchForm.yishenggonghao,	
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yisheng/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yisheng");
